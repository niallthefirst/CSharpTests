...
namespace TasksAndParallelism
{
    public class AsyncAwaitTest
    {
        ...
        static async void ProcessDataAsync()
        {
            ...
            Task<int> handlFileAsyncTask = HandleFileAsync("..\\..\\TextFile1.txt");
            ...
            int count = await handlFileAsyncTask;
            


            Console.WriteLine("All Done, Count: " + count);
        }
        ...
        static async Task<int> HandleFileAsync(string file)
        {
            ...
            Console.WriteLine("HandleFile finished.");
            return count;
        }
    }
}